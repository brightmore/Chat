		...
		dialog.getButton(AlertDialog.BUTTON_POSITIVE).setOnClickListener(
				new View.OnClickListener() {
					...
					public void onClick(View v) {
                        ...
                        if(!jid.getText().toString().equals("")) {
							...
							try {
                                if (Validator.isValidJid(jid.getText().toString())) contactJid = Jid.fromString(jid.getText().toString());
                                else contactJid = Jid.fromString(jid.getText().toString()+"@"+accountJid.getDomainpart());
							} catch (final InvalidJidException e) {
								return;
							}
				...
				new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						if(!jid.getText().toString().equals("")) {
							...
							try {
                                if(Validator.isValidJid(jid.getText().toString())) conferenceJid = Jid.fromString(jid.getText().toString());
                                else conferenceJid = Jid.fromString(jid.getText().toString()+"@conference."+accountJid.getDomainpart());
							} catch (final InvalidJidException e) {
							...
							jid.setError(getString(R.string.empty_conference));
						}
					}
				});
	}
