...
public class XmppConnectionService extends Service {
    ...
    private String[] certificatePins = new String[] {
            "5f5731a3441ed16c42c5f1b7ffc5b6b7d852dcb9e93b6ba637b7fc821858ed36",     // upperechelon.info
            "96bc15437450ba798cba0dcf018854434482c339a1529a7c6a3fe4870cc6885a",     // jabber.org
            "dfca35278eada8dfb1f4449f1dde24e0dc4a5e17b614f26edbaabdc8da0ea658",     // dukgo.com
            "a39b36307e7bf593734a9beea90c76667a8badc8e7c1ee4b5011dff35f3384c6",     // jabber.calyxinstitute.org
            "cb4822b9d6e15fe1b229a6e40644e33314f25a6f8a4f52a0fa70d5561beb2ab3",     // jabber.ccc.de
            "888f451a4c067639c377d2946a7b3c1dd1a437fd5456d769ee7a9d7823771fc3",     // chat.facebook.com
    };
	...
	public void onCreate() {
        ...
        this.mMemorizingTrustManager = new MemorizingTrustManager(
                getApplicationContext(),
                new PinningTrustManager(SystemKeyStore.getInstance(getApplicationContext()), this.certificatePins, 0, false)
        );
	...
	public void toggleForegroundService() {
		if (getPreferences().getBoolean("keep_foreground_service",true)) {
