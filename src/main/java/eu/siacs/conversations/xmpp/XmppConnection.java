...
public class XmppConnection implements Runnable {
    ...
    private void switchOverToTls(Tag currentTag) throws XmlPullParserException,
        ...
        try {
            ...
            String minimumProtocol = getPreferences().getString("minimum_encryption", "TLS 1.2");
            ...
            String minimumCiphers = getPreferences().getString("minimum_ciphers", "High Strength");
            ...
            sendStartStream();
            Log.d(Config.LOGTAG, account.getJid() + ": TLS connection established");
