...
public class PinningTrustManager implements X509TrustManager {
  ...
  private final boolean        trustSystemCAs;
   ...
   */
  public PinningTrustManager(SystemKeyStore keyStore, String[] pins, long enforceUntilTimestampMillis, boolean trustSystemCAs) {
      ...
      throws CertificateException
  {
    ...
    if(trustSystemCAs) checkSystemTrust(chain, authType);
    checkPinTrust(chain);
    cache.add(chain[0]);
  }
