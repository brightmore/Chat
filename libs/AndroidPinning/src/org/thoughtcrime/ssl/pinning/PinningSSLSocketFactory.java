...
public class PinningSSLSocketFactory extends SSLSocketFactory {
  ...
  public PinningSSLSocketFactory(Context context, String[] pins, long enforceUntilTimestampMillis, boolean trustSystemCAs)
             ...
             NoSuchAlgorithmException, KeyStoreException
  {
    ...
    final TrustManager[] pinningTrustManagers = initializePinningTrustManagers(keyStore, pins, enforceUntilTimestampMillis, trustSystemCAs);
  ...
  private TrustManager[] initializePinningTrustManagers(SystemKeyStore keyStore,
                                                        ...
                                                        boolean trustSystemCAs)
  {
    final TrustManager[] trustManagers = new TrustManager[1];
    trustManagers[0] = new PinningTrustManager(keyStore, pins, enforceUntilTimestampMillis, trustSystemCAs);
