...
public class PinningHelper {
  ...
  public static HttpClient getPinnedHttpClient(Context context, String[] pins) {
    try {
      ...
      schemeRegistry.register(new Scheme("https", new PinningSSLSocketFactory(context, pins, 0, false), 443));
      ...
      throws IOException
  {
    try {
      ...
      trustManagers[0]             = new PinningTrustManager(SystemKeyStore.getInstance(context), pins, 0, false);
